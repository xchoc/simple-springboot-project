...
import com.example.simple.springboot.project.config.TokenAuthentication;
...
public class CallbackController {
    ...
    private void handle(HttpServletRequest req, HttpServletResponse res) throws IOException {
        try {
            ...
            AuthAPI auth = new AuthAPI(authConfig.getDomain(), authConfig.getClientId(), authConfig.getClientSecret());
            Request<UserInfo> userInfoRequest = auth.userInfo(tokens.getAccessToken());
